...
public class SwipeButton extends RelativeLayout {
       ...
       // final ImageView swipeButton = new ImageView(context);
        ...
        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            ...
            if (backgroundDrawable != null) {
                ...
                background.setBackground(getDrawable(context, R.drawable.shape_rounded));
            }
            ...
            centerText.setText(typedArray.getText(R.styleable.SwipeButton_inner_text_line1));
            centerText.append(System.lineSeparator());
            centerText.append(typedArray.getText(R.styleable.SwipeButton_inner_text_line2));
            ...
            if (buttonBackground != null) {
                ...
                swipeButtonInner.setBackground(getDrawable(context, R.drawable.shape_button));
            }
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        if (active) {
                            ...
                            if (swipeButtonInner.getX() + swipeButtonInner.getWidth() > getWidth() * 0.8) {
                                if (hasActivationState) {
                                    //centerText.setText("Done");
                                    //expandButton();
                                    moveButtonBack();
    ...
    private float converPixelsToSp(float px, Context context) {
